	...
	this._fetchPlaylist().then(pllstdata => {
		  ...
		  var fetches = []
                    ...
                    count.author = pllstdata.programs[i].dj.nickname
                        ...
                        var songurl = 'https://netease.project.ac.cn/song/url?id=:rid&r=:r'
	   ...
	   Promise.all(fetches).then(() => window.alert(djplaylist)).then(() => this._loadPlayer(djplaylist))
   })
            }
