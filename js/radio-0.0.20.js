                ...
                for (var i = 0; i <= data.programs.length - 1; i++) {
                    ...
                    this.count.author = data.programs[i].dj.nickname
                        ...
                        .then((data1) => {
                            ...
                            djplaylist.push(this.count)
							window.alert(JSON.stringify(djplaylist))
                        })
                }
            })
			.then(djplaylist => window.alert(JSON.stringify(djplaylist)))
            .then(djplaylist => this._loadPlayer(djplaylist))
    }
